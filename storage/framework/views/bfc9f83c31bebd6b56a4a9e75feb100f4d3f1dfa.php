        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="<?php echo e(url('home')); ?>" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="<?php echo e(asset('img/logo.jpg')); ?>" alt="logo-sm"
                            width="100%">
                    </span>
                    <span class="logo-lg">
                        <img src="<?php echo e(asset('img/logo.jpg')); ?>" alt="logo-dark"
                            width="100%">
                    </span>
                </a>
                ...
                <a href="<?php echo e(url('home')); ?>" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="<?php echo e(asset('img/logo.jpg')); ?>" alt="logo-sm-light"
                            width="100%">
                    </span>
                    <span class="logo-lg">
                        <img src="<?php echo e(asset('img/logo.jpg')); ?>" alt="logo-light"
                            width="100%">
                    </span>
                </a>
            </div>
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    ...
                    <img class="rounded-circle header-profile-user"
                        src="<?php echo e(parse_url(admin()->avatar, PHP_URL_SCHEME) == 'https' || parse_url(admin()->avatar, PHP_URL_SCHEME) == 'http'
                            ? admin()->avatar
                            : Storage::url(admin()->avatar)); ?>"
                        alt="Header Avatar">
                    <span class="d-none d-xl-inline-block ms-1"><?php echo e(admin()->name); ?></span>
                    <i class="mdi mdi-chevron-down d-none d-xl-inline-block"></i>
                </button>
                <div class="dropdown-menu dropdown-menu-end">
                    <!-- item-->
                    <h6 class="dropdown-header">Welcome <?php echo e(admin()->name); ?>!</h6>
                    <a class="dropdown-item" href="<?php echo e(route('admin.admin_info.show', auth()->id())); ?>">
                    ...
                    <a class="dropdown-item" href="<?php echo e(route('admin.change.password', auth()->id())); ?>">
                    ...
                    <a class="dropdown-item" href="<?php echo e(route('admin.screen.lock', auth()->id())); ?>">
...
<?php /**PATH C:\xampp\htdocs\talent-pro-lab\resources\views/layouts/admin/inc/header.blade.php ENDPATH**/ ?>