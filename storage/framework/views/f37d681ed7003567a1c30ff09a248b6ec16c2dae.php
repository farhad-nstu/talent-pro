<header id="page-topbar">
    <div class="navbar-header">
        ...
        <div class="dropdown d-inline-block">
            <h2 class='text'><img width="50px" src="<?php echo e(asset('img/logo.jpg')); ?>"
                    alt=""></h2>
        </div>
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    ...
                    <img class="rounded-circle header-profile-user"
                        src="<?php echo e(parse_url(user()->avatar, PHP_URL_SCHEME) == 'https' || parse_url(user()->avatar, PHP_URL_SCHEME) == 'http'
                            ? user()->avatar
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class="dropdown-item" href="<?php echo e(route('user.user_info.show', auth()->id())); ?>">
                    ...
                    <a class="dropdown-item" href="<?php echo e(route('user.change.password', auth()->id())); ?>">
                    ...
                    <a class="dropdown-item" href="<?php echo e(route('user.screen.lock', auth()->id())); ?>">
